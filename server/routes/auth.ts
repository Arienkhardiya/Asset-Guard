...
router.post('/register', async (req, res) => {
  ...
  try {
    ...
    await query(
      `INSERT INTO users (uid, email, password, role, tenant_id, tenant_type, tenant_name) 
       VALUES ($1, $2, $3, $4, $5, $6, $7)`,
      [uid, email, hashedPassword, role || 'Cybersecurity Analyst', tenantId, tenantType || 'Organization', tenantName || 'Default Tenant']
    );
