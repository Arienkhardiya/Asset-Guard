...
router.post('/register', async (req, res) => {
    ...
    try {
        ...
        await query(`INSERT INTO users (uid, email, role, tenant_id, tenant_type) 
       VALUES ($1, $2, $3, $4, $5)`, [uid, email, role || 'Cybersecurity Analyst', tenantId, tenantType || 'Organization']);
        const token = jwt.sign({ uid, email, role: role || 'Cybersecurity Analyst', tenantId, tenantType: tenantType || 'Organization' }, JWT_SECRET, { expiresIn: '24h' });
...
router.post('/login', async (req, res) => {
    ...
    try {
        ...
        if (rows.length === 0) {
            ...
            await query(`INSERT INTO users (uid, email, role, tenant_id, tenant_type) 
         VALUES ($1, $2, $3, $4, $5)`, [uid, email, role, tenantId, tenantType]);
